...
fun HapticFeedback.gestureThresholdActivate() = performHapticFeedback(HapticFeedbackType.GestureThresholdActivate)
fun HapticFeedback.keyboardTap() = performHapticFeedback(HapticFeedbackType.KeyboardTap)
...
fun HapticFeedback.segmentFrequentTick() = performHapticFeedback(HapticFeedbackType.SegmentFrequentTick)
